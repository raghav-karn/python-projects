...
sentence = "I think it's interesting that 'cologne' rhymes with 'alone'", "has 9 words"
...
print_(first_word(words))
print_(last_word(words))
print_(first_and_last_word(sentence))